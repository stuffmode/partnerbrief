    ...
    <>
      ...
      <section>
        <div className="hero">
          <div className="hero-left">
            <div className="hero-eyebrow"><span className="eyebrow-dot"></span>Now accepting founding members</div>
            <h1>Your partners stay<br /><em>informed, engaged,</em><br />and selling.</h1>
            <p className="hero-sub">Partner Brief turns your internal data, research, and trends into personalized partner newsletters and audio briefings, automatically delivered to every partner to keep them informed and keep them selling.</p>
            <p className="hero-sub">No PRM. No manual updates. No partners going dark.</p>
            ...
            <div className="waitlist-form">
              ...
              <button className="waitlist-btn" id="hero-btn">Join the waitlist</button>
            </div>
      ...
      <section className="how-bg" id="how">
        <div className="section">
          ...
          <p className="section-sub">Partner Brief ingests your internal signals, layers in external market intelligence, and auto-generates personalized briefings by partner, region, or team.</p>
          <div className="pipeline">
            <div className="pipeline-stage">
              <div className="pipeline-stage-label">01 · Connect</div>
              <div className="pipeline-stage-title">Your internal sources</div>
              <div className="pipeline-items">
                <div className="pipeline-item"><div className="pipeline-item-icon"><svg width="13" height="13" viewBox="0 0 13 13" fill="none"><rect x="1" y="1" width="11" height="11" rx="2" stroke="rgba(255,255,255,0.6)" strokeWidth="1.1"/><path d="M3.5 6.5h6M3.5 4h6M3.5 9h4" stroke="rgba(255,255,255,0.6)" strokeWidth="1.1" strokeLinecap="round"/></svg></div>Slack channels</div>
                <div className="pipeline-item"><div className="pipeline-item-icon"><svg width="13" height="13" viewBox="0 0 13 13" fill="none"><circle cx="6.5" cy="4.5" r="2" stroke="rgba(255,255,255,0.6)" strokeWidth="1.1"/><path d="M2 11.5c0-2.2 2-4 4.5-4s4.5 1.8 4.5 4" stroke="rgba(255,255,255,0.6)" strokeWidth="1.1" strokeLinecap="round"/></svg></div>CRM data</div>
                <div className="pipeline-item"><div className="pipeline-item-icon"><svg width="13" height="13" viewBox="0 0 13 13" fill="none"><circle cx="6.5" cy="6.5" r="5" stroke="rgba(255,255,255,0.6)" strokeWidth="1.1"/><path d="M5 5l3.5 1.5L5 8V5z" fill="rgba(255,255,255,0.6)"/></svg></div>Call recordings</div>
                <div className="pipeline-item"><div className="pipeline-item-icon"><svg width="13" height="13" viewBox="0 0 13 13" fill="none"><path d="M7.5 1H3a1 1 0 00-1 1v9a1 1 0 001 1h7a1 1 0 001-1V5.5L7.5 1z" stroke="rgba(255,255,255,0.6)" strokeWidth="1.1"/><path d="M7.5 1v4.5H12" stroke="rgba(255,255,255,0.6)" strokeWidth="1.1"/></svg></div>Assets and docs</div>
                <div className="pipeline-item"><div className="pipeline-item-icon"><svg width="13" height="13" viewBox="0 0 13 13" fill="none"><rect x="1" y="3" width="11" height="9" rx="1.5" stroke="rgba(255,255,255,0.6)" strokeWidth="1.1"/><path d="M4.5 3V2M8.5 3V2" stroke="rgba(255,255,255,0.6)" strokeWidth="1.1" strokeLinecap="round"/><path d="M3 7h7M3 9.5h4" stroke="rgba(255,255,255,0.6)" strokeWidth="1.1" strokeLinecap="round"/></svg></div>Project tools</div>
              </div>
            </div>
            ...
            <div className="pipeline-stage pipeline-middle">
              ...
              <div className="pipeline-stage-title">Partner Brief AI</div>
              <div className="pipeline-items">
                <div className="pipeline-item"><div className="pipeline-item-icon"><svg width="13" height="13" viewBox="0 0 13 13" fill="none"><path d="M6.5 1l1.2 3.2H11l-2.5 1.9 1 3.1-3.5-2.4L3.5 9.2l1-3.1L2 4.2h3.3L6.5 1z" stroke="rgba(255,255,255,0.9)" strokeWidth="1.1" strokeLinejoin="round"/></svg></div>Synthesizes signals</div>
                <div className="pipeline-item"><div className="pipeline-item-icon"><svg width="13" height="13" viewBox="0 0 13 13" fill="none"><circle cx="6.5" cy="6.5" r="5" stroke="rgba(255,255,255,0.9)" strokeWidth="1.1"/><circle cx="6.5" cy="6.5" r="1.8" fill="rgba(255,255,255,0.9)"/></svg></div>Personalizes by partner</div>
                <div className="pipeline-item"><div className="pipeline-item-icon"><svg width="13" height="13" viewBox="0 0 13 13" fill="none"><circle cx="6.5" cy="6.5" r="5" stroke="rgba(255,255,255,0.9)" strokeWidth="1.1"/><path d="M6.5 1.5C6.5 1.5 4.5 4.5 4.5 6.5s2 5 2 5M6.5 1.5C6.5 1.5 8.5 4.5 8.5 6.5s-2 5-2 5M1.5 6.5h10" stroke="rgba(255,255,255,0.9)" strokeWidth="1.1"/></svg></div>Segments by region</div>
                <div className="pipeline-item"><div className="pipeline-item-icon"><svg width="13" height="13" viewBox="0 0 13 13" fill="none"><path d="M2 9.5l3-3 2 2 4.5-5" stroke="rgba(255,255,255,0.9)" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/></svg></div>Layers market trends</div>
                <div className="pipeline-item"><div className="pipeline-item-icon"><svg width="13" height="13" viewBox="0 0 13 13" fill="none"><path d="M2 6.5l3.5 3.5 5.5-6" stroke="rgba(255,255,255,0.9)" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round"/></svg></div>Reviews and sends</div>
              </div>
            </div>
            <div className="pipeline-arrow"><svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M5 12h14M14 7l5 5-5 5" stroke="rgba(255,255,255,0.2)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg></div>
            <div className="pipeline-stage">
              <div className="pipeline-stage-label">03 · Deliver</div>
              <div className="pipeline-stage-title">Partner gets</div>
              <div className="pipeline-items">
                <div className="pipeline-item"><div className="pipeline-item-icon"><svg width="13" height="13" viewBox="0 0 13 13" fill="none"><path d="M2 3.5a1 1 0 011-1h7a1 1 0 011 1v6a1 1 0 01-1 1H3a1 1 0 01-1-1v-6z" stroke="rgba(255,255,255,0.6)" strokeWidth="1.1"/><path d="M2 5l4.5 3L11 5" stroke="rgba(255,255,255,0.6)" strokeWidth="1.1" strokeLinecap="round"/></svg></div>Weekly newsletter</div>
                <div className="pipeline-item"><div className="pipeline-item-icon"><svg width="13" height="13" viewBox="0 0 13 13" fill="none"><circle cx="6.5" cy="6.5" r="5" stroke="rgba(255,255,255,0.6)" strokeWidth="1.1"/><path d="M5 5l4 1.5-4 1.5V5z" fill="rgba(255,255,255,0.6)"/></svg></div>Audio briefing</div>
                <div className="pipeline-item"><div className="pipeline-item-icon"><svg width="13" height="13" viewBox="0 0 13 13" fill="none"><path d="M2 9.5l3-3 2 2 4.5-5" stroke="rgba(255,255,255,0.6)" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/></svg></div>Market intelligence</div>
                <div className="pipeline-item"><div className="pipeline-item-icon"><svg width="13" height="13" viewBox="0 0 13 13" fill="none"><path d="M6.5 1.5l1 2.8h3l-2.3 1.7 1 2.7-2.7-2-2.7 2 1-2.7L2.5 4.3h3l1-2.8z" stroke="rgba(255,255,255,0.6)" strokeWidth="1.1" strokeLinejoin="round"/></svg></div>Win stories and CTAs</div>
                <div className="pipeline-item"><div className="pipeline-item-icon"><svg width="13" height="13" viewBox="0 0 13 13" fill="none"><path d="M6.5 2v2.5M6.5 8.5V11M2 6.5h2.5M8.5 6.5H11" stroke="rgba(255,255,255,0.6)" strokeWidth="1.1" strokeLinecap="round"/><circle cx="6.5" cy="6.5" r="2" stroke="rgba(255,255,255,0.6)" strokeWidth="1.1"/></svg></div>Product updates</div>
              </div>
            </div>
          </div>
        </div>
